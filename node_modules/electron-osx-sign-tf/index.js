...
function signApplication (opts) {
  ...
  function addIfBinary (filePath) {
    return isFileBinary(filePath)
  ...
  return walk(generateAppContentsPath(opts))
    .then(function () {
      return signFiles(opts, opts.binaries ? childPaths.concat(opts.binaries) : childPaths)
    })
}
